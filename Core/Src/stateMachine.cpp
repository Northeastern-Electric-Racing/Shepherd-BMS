...
uint32_t StateMachine::faultReturn(AccumulatorData_t *accData)
{
	...
	static struct fault_eval fault_table[9] = 
        {
          // ___________FAULT ID_______________  __________TIMER_______________   _____________DATA________________    __OPERATOR__   __________________________THRESHOLD_____________________________  _______TIMER LENGTH_____________  _____________FAULT CODE_________________    _______________DATA_____________________  ___OPERATOR___  ________THRESHOLD________
			...
			{.id = "Internal Cell Communication" .timer = internalCellComm_tmr,   .data_1 =   CELL_COMM_FAULT_STATUS, .optype_1 = NEQ, .lim_1 =                                                     0,  .timeout = INTERN_CELL_COMM_TIME, .code =         INTERNAL_CELL_COMM_FAULT   /* -----------------------------------UNUSED---------------------------------*/  }, 
